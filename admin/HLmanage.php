                ...
                <form id="form_new" method="POST">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-col l10 m10 s12">
                            <input type="checkbox"><label>&ensp;全選&ensp;</label>
            ...
            <?php foreach ($get_query_result as $HL) : ?>
                <div class="card" style=" background:blanchedalmond;">
                    ...
                    <div class="card-body w3-row">
                        <div class="w3-col l4 m6 s12"><img src="../image/HL-1.jpg" alt="" style="width: 200px;"></div>
                        <div class="w3-col l8 m6 s12">
                            <div><input type="text" style="margin: 5px;" placeholder="<?php echo $HL['title']; ?>" name="edit_input_title" id="edit_title_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled></div>
                            <div><input type=" text" style="margin: 5px;" placeholder="<?php echo $HL['URL']; ?>" name="edit_input_URL" id="edit_URL_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled></div>
                            <div><textarea style="margin: 5px;" placeholder="<?php echo $HL['introduce']; ?>" name="edit_input_introduce" id="edit_introduce_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled></textarea></div>
                        </div>
                    </div>
                    <div class="card-foot w3-row">
                        ...
                        <div class="w3-col l8 m6 s12">
                            ...
                            <input type="checkbox" name="edit_tag01" id="edit_tag01_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag01'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;01&ensp;</label>
                            <input type="checkbox" name="edit_tag07" id="edit_tag07_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag07'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;07&ensp;</label>
                            <input type="checkbox" name="edit_tag08" id="edit_tag08_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag08'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;08&ensp;</label>
                            <input type="checkbox" name="edit_tag21" id="edit_tag21_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag21'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;21&ensp;</label>
                            <input type="checkbox" name="edit_tag27" id="edit_tag27_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag27'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;27&ensp;</label>
                            <input type="checkbox" name="edit_tag32" id="edit_tag32_<?php echo $HL['ID']; ?>" data-id="<?php echo $HL['ID']; ?>" disabled <?php if ($HL['tag32'] == 1) : ?>checked<?php endif; ?>><label for="title">&ensp;32&ensp;</label>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        ...
        <div class="container">
            <?php foreach ($get_query_result as $HL) : ?>
                <div class="card" style=" background:blanchedalmond;" id="del_card_<?php echo $HL['ID'];?>">
                    ...
                    <div class="card-body w3-row">
                        <div class="w3-col l4 m6 s12"><img src="../image/B-bg.jpg" alt="" style="width: 200px;"></div>
                        <div class="w3-col l8 m6 s12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("[name=btn_save]").click(function() {
                ...
                if($(tag01_id).prop("checked") == true){tag01=1;}else{tag01=0;}
                if($(tag07_id).prop("checked") == true){tag07=1;}else{tag07=0;}
                if($(tag08_id).prop("checked") == true){tag08=1;}else{tag08=0;}
                if($(tag21_id).prop("checked") == true){tag21=1;}else{tag21=0;}
                if($(tag27_id).prop("checked") == true){tag27=1;}else{tag27=0;}
                if($(tag32_id).prop("checked") == true){tag32=1;}else{tag32=0;}
